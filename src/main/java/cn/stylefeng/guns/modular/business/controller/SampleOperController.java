...
public class SampleOperController {
     ...
     */
    @PostResource(name = "上传文件", path = "/Sample/tinymceUpload", requiredPermission = false)
     ...
     */
    @PostResource(name = "替换文件", path = "/Sample/update", requiredPermission = false)
     ...
     * @date 2020/12/16 15:34
     */
    @PostResource(name = "替换文件", path = "/Sample/versionBack", requiredPermission = false)
     ...
     * @date 2020/12/27 13:17
     */
    @GetResource(name = "根据附件IDS查询附件信息", path = "/Sample/getFileInfoListByFileIds", requiredPermission = false)
     ...
     */
    @GetResource(name = "分页查询文件信息表", path = "/Sample/fileInfoListPage", requiredPermission = false)
     ...
     */
    @PostResource(name = "确认替换附件", path = "/Sample/confirmReplaceFile", requiredPermission = false)
